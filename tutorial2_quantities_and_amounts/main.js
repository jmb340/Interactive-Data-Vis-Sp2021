...
d3.csv('../data/nyucovidvirtualtraining.csv', d3.autoType)
  .then(data => {
    ...
    const margins = { top: 45, bottom: 50, left: 5, right: 5 };
    ...
    svg.selectAll("rect")
      ...
      .attr("fill", "Purple") // try changing this to be a dynamic colorscale
